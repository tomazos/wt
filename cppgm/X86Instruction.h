...
struct X86Instruction {
  ...
  void fixup(size_t addr) {
    ...
    if (data.size() != 8)
      throw logic_error("unexpected label fixup size: " +
                        to_string(data.size()));
  ...
  vector<byte> get_machine_code() const {
    if (raw_data_active) return raw_data;

    vector<byte> result;

    if (operand_size_prefix) result.push_back(0x66);
    ...
    if (opcode2_active) result.push_back(opcode2);
    ...
    if (modrm_active) {
      ...
      //			cout << "modrm_byte: " << int(modrm_byte) <<
      //endl;
  ...
  void set_unary(byte opcode_8, byte opcode_16_64, size_t operand_size) {
    if (operand_size == 1) {
    ...
    if (operand_size == 2) operand_size_prefix = true;

    if (operand_size == 8) REX_W = true;
  }

  void set_plus_reg(int code) {
    if (code < 0 || code >= 16) throw logic_error("invalid reg code");

    if (code & 8) REX_B = true;
  ...
  void set_unary_reg_mem(byte opcode_origin, int reg_op, size_t operand_size) {
    if (reg > 7) throw logic_error("invalid reg/unary");
...
enum X86OperandCategory { XOC_REGISTER, XOC_MEMORY };
...
struct X86Operand {
  ...
  X86Operand(memory_marker, X86Register base_reg, signed long int delta,
             size_t operand_size)
...
inline X86Operand mem(X86Register base_register, signed long int delta = 0,
                      size_t width = 0) {
...
inline X86Instruction X86UnaryInstruction(byte opcode1, int reg_op,
                                          X86Operand o,
                                          size_t operand_size = 0) {
  X86Instruction out;

  if (o.operand_size == 0) o.operand_size = operand_size;
  ...
  if (o.operand_category == XOC_MEMORY && o.operand_size == 0)
    throw logic_error(
        "unary instruction with mem op requires explicit operand size");
  ...
  switch (o.operand_category) {
    case XOC_MEMORY:
      ...
      break;
    case XOC_REGISTER:
      out.set_rm_reg(o.base_register);
      break;
  }
...
inline X86Instruction X86UnaryByteInstruction(byte opcode1, byte opcode2,
                                              X86Operand o) {
  if (o.operand_size == 0) o.operand_size = 1;

  if (o.operand_size != 1) throw logic_error("invalid operand size");
...
inline X86Instruction X86MemUnaryInstruction(byte opcode1, int reg_op,
                                             X86Operand o) {
...
inline X86Instruction X86BinaryInstruction(byte opcode_left, byte opcode_right,
  ...
  if (dest.operand_category == XOC_MEMORY && src.operand_category == XOC_MEMORY)
  ...
  else if (dest.operand_category == XOC_REGISTER &&
           src.operand_category == XOC_REGISTER) {
    ...
    out.set_reg(src.base_register);
             ...
             src.operand_category == XOC_MEMORY) {
  ...
  } else if (dest.operand_category == XOC_MEMORY &&
             src.operand_category == XOC_REGISTER) {
...
inline X86Instruction XI_FFREE(int st) {
  return X86NoaryInstruction(0xDD, 0xC0 + st);
}

inline X86Instruction XI_SETE(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x94, o);
}
inline X86Instruction XI_SETNE(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x95, o);
}
inline X86Instruction XI_SETA(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x97, o);
}
inline X86Instruction XI_SETAE(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x93, o);
}
inline X86Instruction XI_SETB(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x92, o);
}
inline X86Instruction XI_SETBE(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x96, o);
}
inline X86Instruction XI_SETL(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x9C, o);
}
inline X86Instruction XI_SETLE(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x9E, o);
}
inline X86Instruction XI_SETG(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x9F, o);
}
inline X86Instruction XI_SETGE(X86Operand o) {
  return X86UnaryByteInstruction(0x0F, 0x9D, o);
}

inline X86Instruction XI_NOT(X86Operand o) {
  return X86UnaryInstruction(0xF6, 2, o);
}
inline X86Instruction XI_SHL(X86Operand o) {
  return X86UnaryInstruction(0xD2, 4, o);
}
inline X86Instruction XI_SHR(X86Operand o) {
  return X86UnaryInstruction(0xD2, 5, o);
}
inline X86Instruction XI_SAR(X86Operand o) {
  return X86UnaryInstruction(0xD2, 7, o);
}
inline X86Instruction XI_MUL(X86Operand o) {
  return X86UnaryInstruction(0xF6, 4, o);
}
inline X86Instruction XI_IMUL(X86Operand o) {
  return X86UnaryInstruction(0xF6, 5, o);
}
inline X86Instruction XI_DIV(X86Operand o) {
  return X86UnaryInstruction(0xF6, 6, o);
}
inline X86Instruction XI_IDIV(X86Operand o) {
  return X86UnaryInstruction(0xF6, 7, o);
}

inline X86Instruction XI_MOV(X86Operand dest, X86Operand src) {
  return X86BinaryInstruction(0x88, 0x8A, dest, src);
}
inline X86Instruction XI_AND(X86Operand dest, X86Operand src) {
  return X86BinaryInstruction(0x20, 0x22, dest, src);
}
inline X86Instruction XI_OR(X86Operand dest, X86Operand src) {
  return X86BinaryInstruction(0x08, 0x0A, dest, src);
}
inline X86Instruction XI_XOR(X86Operand dest, X86Operand src) {
  return X86BinaryInstruction(0x30, 0x32, dest, src);
}
inline X86Instruction XI_ADD(X86Operand dest, X86Operand src) {
  return X86BinaryInstruction(0x00, 0x02, dest, src);
}
inline X86Instruction XI_SUB(X86Operand dest, X86Operand src) {
  return X86BinaryInstruction(0x28, 0x2A, dest, src);
}
inline X86Instruction XI_CMP(X86Operand dest, X86Operand src) {
  return X86BinaryInstruction(0x38, 0x3A, dest, src);
}
...
inline X86Instruction XI_MOV(X86Operand dest, vector<byte> imm) {
  ...
  return X86RegImmInstruction(0xB0, 0xB8, dest.operand_size, dest.base_register,
                              imm);
}
...
inline X86Instruction XI_JMP(X86Operand target) {
  ...
  switch (target.operand_category) {
    case XOC_MEMORY:
      out.set_rm_mem(target.base_register, target.memory_delta);
      break;
    case XOC_REGISTER:
      out.set_rm_reg(target.base_register);
      break;
  }
...
inline X86Instruction XI_FILD(X86Operand src) {
  switch (src.operand_size) {
    case 2:
      return X86MemUnaryInstruction(0xDF, 0, src);
    case 4:
      return X86MemUnaryInstruction(0xDB, 0, src);
    case 8:
      return X86MemUnaryInstruction(0xDF, 5, src);
    default:
      throw logic_error("FILD invalid operand size: " +
                        to_string(src.operand_size));
  }
}
...
inline X86Instruction XI_FLD(X86Operand src) {
  switch (src.operand_size) {
    case 4:
      return X86MemUnaryInstruction(0xD9, 0, src);
    case 8:
      return X86MemUnaryInstruction(0xDD, 0, src);
    case 10:
      return X86MemUnaryInstruction(0xDB, 5, src);
    default:
      throw logic_error("FLD invalid operand size" +
                        to_string(src.operand_size));
  }
}
...
inline X86Instruction XI_FISTP(X86Operand dest) {
  switch (dest.operand_size) {
    case 2:
      return X86MemUnaryInstruction(0xDF, 3, dest);
    case 4:
      return X86MemUnaryInstruction(0xDB, 3, dest);
    case 8:
      return X86MemUnaryInstruction(0xDF, 7, dest);
    default:
      throw logic_error("FISTP invalid operand size");
  }
}
...
inline X86Instruction XI_FSTP(X86Operand dest) {
  switch (dest.operand_size) {
    case 4:
      return X86MemUnaryInstruction(0xD9, 3, dest);
    case 8:
      return X86MemUnaryInstruction(0xDD, 3, dest);
    case 10:
      return X86MemUnaryInstruction(0xDB, 7, dest);
    default:
      throw logic_error("FSTP invalid operand size");
  }
}
