...
struct SemObject;
// 1. Current dynamically allocated classes derived from SemObject are registered with a memory pool.
...
inline ostream& operator<<(ostream& o, const Pooled& p) { p.write(o); return o; }
inline ostream& operator<<(ostream& o, const Pooled* p) { if (p) p->write(o); else o << "null"; return o; }
