...
struct DeclarationStatement : Statement {
  ...
  DeclarationStatement(Declaration* declaration) : declaration(declaration) {}
};
...
struct CaseStatement : Statement {
  ...
  CaseStatement(RawExpression* case_expression, Statement* statement)
      : case_expression(case_expression), statement(statement) {}
};
...
struct CompoundStatement : Statement {
  ...
  void push_statement(Statement* statement) { statements.push_back(statement); }
};

struct ExpressionStatement : Statement {
  RawExpression* expression;

  ExpressionStatement(RawExpression* expression) : expression(expression) {}
};
...
struct ForStatement : Statement {
  ...
  ForStatement(Statement* init_statement, Condition* condition,
               RawExpression* expression, Statement* statement)
...
struct ReturnStatement : Statement {
  ...
  ReturnStatement(RawExpression* expression) : expression(expression) {}
};

struct GotoStatement : Statement {
  string label;

  GotoStatement(const string& label) : label(label) {}
};
