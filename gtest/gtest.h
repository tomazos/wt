...
//
// GFAIL and ASSERT_* are similar to ADD_FAILURE and EXPECT_*, except
// that they will also abort the current function on failure.  People
// usually want the fail-fast behavior of GFAIL and ASSERT_*, but those
...
// Define this macro to 1 to omit the definition of GFAIL(), which is a
// generic name and clashes with some other libraries.
#if !GTEST_DONT_DEFINE_FAIL
#define GFAIL() GTEST_FAIL()
#endif
...
#define GTEST_ASSERT_EQ(actual, expected)                                   \
