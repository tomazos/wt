...
// WARNING:
//	This code is really experimental. It was written in response to some
// people
//	asking for a servo driver, however while it works, there is too much
//	jitter to successfully drive a small servo - I have tried it with a
// micro
//	servo and it worked, but the servo ran hot due to the jitter in the
// signal
//	being sent to it.
//
...
int softServoSetup(int p0, int p1, int p2, int p3, int p4, int p5, int p6,
                   int p7) {
  int servo;
