...
class ParametrizedLine {
 public:
  ...
  inline explicit ParametrizedLine(Index _dim)
  ...
  template <int OtherOptions>
  explicit ParametrizedLine(
      const Hyperplane<_Scalar, _AmbientDim, OtherOptions>& hyperplane);

  /** Constructs a parametrized line going from \a p0 to \a p1. */
  static inline ParametrizedLine Through(const VectorType& p0,
                                         const VectorType& p1) {
  ...
  inline explicit ParametrizedLine(const ParametrizedLine<
