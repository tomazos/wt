...
#define EIGEN_MAKE_CWISE_COMP_OP(OP, COMPARATOR)                               \
  template <typename OtherDerived>                                             \
  EIGEN_STRONG_INLINE const CwiseBinaryOp<                                     \
      internal::scalar_cmp_op<Scalar, internal::cmp_##COMPARATOR>,             \
      const Derived, const OtherDerived>                                       \
  ...
  typedef CwiseBinaryOp<                                                       \
      ...
      const CwiseNullaryOp<internal::scalar_constant_op<Scalar>,               \
                           PlainObject> > Cmp##COMPARATOR##ReturnType;         \
  typedef CwiseBinaryOp<                                                       \
      internal::scalar_cmp_op<Scalar, internal::cmp_##COMPARATOR>,             \
      const CwiseNullaryOp<internal::scalar_constant_op<Scalar>, PlainObject>, \
      const Derived> RCmp##COMPARATOR##ReturnType;                             \
  EIGEN_STRONG_INLINE const Cmp##COMPARATOR##ReturnType OP(const Scalar& s)    \
      const {                                                                  \
    return this->OP(Derived::PlainObject::Constant(rows(), cols(), s));        \
  }                                                                            \
  friend EIGEN_STRONG_INLINE const RCmp##COMPARATOR##ReturnType OP(            \
...
#define EIGEN_MAKE_CWISE_COMP_R_OP(OP, R_OP, RCOMPARATOR)                 \
  template <typename OtherDerived>                                        \
  EIGEN_STRONG_INLINE const CwiseBinaryOp<                                \
      internal::scalar_cmp_op<Scalar, internal::cmp_##RCOMPARATOR>,       \
...
/** \returns an expression of the coefficient-wise && operator of *this and \a
  ...
  */
template <typename OtherDerived>
inline const CwiseBinaryOp<internal::scalar_boolean_and_op, const Derived,
                           const OtherDerived>
operator&&(const EIGEN_CURRENT_STORAGE_BASE_CLASS<OtherDerived>& other) const {
  EIGEN_STATIC_ASSERT(
...
/** \returns an expression of the coefficient-wise || operator of *this and \a
  ...
  */
template <typename OtherDerived>
inline const CwiseBinaryOp<internal::scalar_boolean_or_op, const Derived,
                           const OtherDerived>
operator||(const EIGEN_CURRENT_STORAGE_BASE_CLASS<OtherDerived>& other) const {
  EIGEN_STATIC_ASSERT(
      (internal::is_same<bool, Scalar>::value &&
