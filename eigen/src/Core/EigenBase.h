...
/** Common base class for all classes T such that MatrixBase has an operator=(T)
  ...
  *MatrixBase.
  *
  * Besides MatrixBase-derived classes, this also includes special matrix
  *classes such as diagonal matrices, etc.
  *
...
/** \brief Copies the generic expression \a other into *this.
  *
  * \details The expression must provide a (templated) evalTo(Derived& dst)
  *const
