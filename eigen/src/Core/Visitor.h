...
void DenseBase<Derived>::visit(Visitor& visitor) const {
  enum {
    unroll = SizeAtCompileTime != Dynamic && CoeffReadCost != Dynamic &&
             (SizeAtCompileTime == 1 ||
              internal::functor_traits<Visitor>::Cost != Dynamic) &&
...
typename internal::traits<Derived>::Scalar DenseBase<Derived>::minCoeff(
...
/** \returns the minimum of all coefficients of *this and puts in *index its
  ...
  *DenseBase::maxCoeff(IndexType*,IndexType*), DenseBase::visitor(),
  *DenseBase::minCoeff()
  */
template <typename Derived>
template <typename IndexType>
...
/** \returns the maximum of all coefficients of *this and puts in *row and *col
  ...
  * \warning the result is undefined if \c *this contains NaN.
  *
  * \sa DenseBase::minCoeff(IndexType*,IndexType*), DenseBase::visitor(),
  *DenseBase::maxCoeff()
  */
template <typename Derived>
template <typename IndexType>
typename internal::traits<Derived>::Scalar DenseBase<Derived>::maxCoeff(
