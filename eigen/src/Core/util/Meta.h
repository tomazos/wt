...
/** \internal
  * \file Meta.h
  * This file contains generic metaprogramming classes which are not
 * specifically related to Eigen.
...
/** \internal
  ...
  *
  * It supports both the current STL mechanism (using the result_type member) as
  *well as
  * upcoming next STL generation (using a templated result member).
  * If none of these members is provided, then the type of the first argument is
  *returned. FIXME, that behavior is a pretty bad hack.
  */
template <typename T>
struct result_of {};
