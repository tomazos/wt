...
template <typename Lhs, typename Rhs, int Mode, int UpLo = (Mode & Lower)
                                                               ? Lower
                                                               : (Mode& Upper)
                                                                     ? Upper
                                                                     : -1,
          int StorageOrder = int(traits<Lhs>::Flags) &
                             RowMajorBit
...
template <typename Lhs, typename Rhs, int Mode, int UpLo = (Mode & Lower)
                                                               ...
                                                               : (Mode& Upper)
                                                                     ? Upper
                                                                     : -1,
          int StorageOrder = int(Lhs::Flags) &
                             (RowMajorBit) >
