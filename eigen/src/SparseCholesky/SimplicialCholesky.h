...
/** \ingroup SparseCholesky_Module
  ...
  *
  * These classes provide LL^T and LDL^T Cholesky factorizations of sparse
  *matrices that are
  * selfadjoint and positive definite. The factorization allows for solving A.X
  *= B where
  * X and B can be either dense or sparse.
  *
  * In order to reduce the fill-in, a symmetric permutation P is applied prior
 ...
 public:
  ...
  inline const internal::solve_retval<SimplicialCholeskyBase, Rhs> solve(
    ...
    eigen_assert(rows() == b.rows() &&
                 "SimplicialCholeskyBase::solve(): invalid number of rows of "
                 "the right hand side matrix b");
    return internal::solve_retval<SimplicialCholeskyBase, Rhs>(*this,
                                                               b.derived());
  }
  ...
  inline const internal::sparse_solve_retval<SimplicialCholeskyBase, Rhs> solve(
    ...
    eigen_assert(m_isInitialized &&
                 "Simplicial LLT or LDLT is not initialized.");
    eigen_assert(rows() == b.rows() &&
                 "SimplicialCholesky::solve(): invalid number of rows of the "
                 "right hand side matrix b");
    return internal::sparse_solve_retval<SimplicialCholeskyBase, Rhs>(
        *this, b.derived());
  }
...
struct traits<SimplicialLLT<_MatrixType, _UpLo, _Ordering> > {
  ...
  typedef SparseTriangularView<typename CholMatrixType::AdjointReturnType,
                               Eigen::Upper> MatrixU;
...
class SimplicialCholesky
 ...
 public:
  ...
  SimplicialCholesky(const MatrixType& matrix) : Base(), m_LDLT(true) {
    compute(matrix);
  }
