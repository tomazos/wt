...
cholmod_sparse viewAsCholmod(const SparseSelfAdjointView<
...
MappedSparseMatrix<Scalar, Flags, Index> viewAsEigen(cholmod_sparse& cm) {
  return MappedSparseMatrix<Scalar, Flags, Index>(
      ...
      static_cast<Index*>(cm.p), static_cast<Index*>(cm.i),
...
class CholmodBase : internal::noncopyable {
 ...
 public:
  ...
  inline const internal::solve_retval<CholmodBase, Rhs> solve(
      const MatrixBase<Rhs>& b) const {
    eigen_assert(m_isInitialized && "LLT is not initialized.");
    eigen_assert(rows() == b.rows() &&
                 "CholmodDecomposition::solve(): invalid number of rows of the "
  ...
  /** Performs a numeric decomposition of \a matrix
    *
    * The given matrix must have the same sparsity pattern as the matrix on
   ...
   * control over the performed operations.
  ...
  /** \internal */
  template <typename RhsScalar, int RhsOptions, typename RhsIndex,
            typename DestScalar, int DestOptions, typename DestIndex>
...
/** \ingroup CholmodSupport_Module
  ...
  *simplicial LL^T Cholesky factorization
  * using the Cholmod library.
  * This simplicial variant is equivalent to Eigen's built-in SimplicialLLT
  *class. Therefore, it has little practical interest.
  * The sparse matrix A must be selfadjoint and positive definite. The vectors
  *or matrices
  ...
  *
  * \sa \ref TutorialSparseDirectSolvers, class CholmodSupernodalLLT, class
  *SimplicialLLT
  */
...
/** \ingroup CholmodSupport_Module
  ...
  *
  * This class allows to solve for A.X = B sparse linear problems via a
  *simplicial LDL^T Cholesky factorization
  * using the Cholmod library.
  * This simplicial variant is equivalent to Eigen's built-in SimplicialLDLT
  *class. Therefore, it has little practical interest.
  * The sparse matrix A must be selfadjoint and positive definite. The vectors
  *or matrices
  * X and B can be either dense or sparse.
...
/** \ingroup CholmodSupport_Module
  ...
  *
  * This class allows to solve for A.X = B sparse linear problems via a
  *supernodal LL^T Cholesky factorization
  * using the Cholmod library.
  * This supernodal variant performs best on dense enough problems, e.g., 3D
  *FEM, or very high order 2D FEM.
  * The sparse matrix A must be selfadjoint and positive definite. The vectors
  *or matrices
  * X and B can be either dense or sparse.
  *
...
/** \ingroup CholmodSupport_Module
  ...
  *LDL^T Cholesky factorization
  * using the Cholmod library. The sparse matrix A must be selfadjoint and
  ...
  *factorization.
  * The default is to let Cholmod automatically choose between a simplicial and
