...
/** \ingroup QR_Module
  ...
  *rank-revealing and achieve optimal
  * numerical stability. The trade-off is that it is slower than HouseholderQR
  *and ColPivHouseholderQR.
  *
...
class FullPivHouseholderQR {
 public:
  ...
  typedef Matrix<Index, 1, EIGEN_SIZE_MIN_PREFER_DYNAMIC(ColsAtCompileTime,
                                                         RowsAtCompileTime),
                 RowMajor, 1, EIGEN_SIZE_MIN_PREFER_FIXED(MaxColsAtCompileTime,
  ...
  /** This method finds a solution x to the equation Ax=b, where A is the matrix
    ...
    *
    * \returns the exact or least-square solution if the rank is greater or
  ...
  inline const internal::solve_retval<FullPivHouseholderQR, Rhs> solve(
    ...
    return internal::solve_retval<FullPivHouseholderQR, Rhs>(*this,
                                                             b.derived());
  }
  ...
  /** \returns the inverse of the matrix of which *this is the QR decomposition.
      ...
      */ inline const internal::
      solve_retval<FullPivHouseholderQR,
    ...
    for (Index k = 0; k < dec().rank(); ++k) {
      ...
      c.bottomRightCorner(remainingSize, rhs().cols())
          .applyHouseholderOnTheLeft(
              dec().matrixQR().col(k).tail(remainingSize - 1),
...
struct FullPivHouseholderQRMatrixQReturnType
 ...
 public:
  ...
  typedef Matrix<typename MatrixType::Scalar, 1, MatrixType::RowsAtCompileTime,
                 RowMajor, 1, MatrixType::MaxRowsAtCompileTime> WorkVectorType;
