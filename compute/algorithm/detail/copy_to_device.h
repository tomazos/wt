...
inline DeviceIterator copy_to_device(HostIterator first, HostIterator last,
  ...
  queue.enqueue_write_buffer(result.get_buffer(), offset * sizeof(value_type),
...
inline future<DeviceIterator> copy_to_device_async(HostIterator first,
  ...
  event event_ = queue.enqueue_write_buffer_async(
      result.get_buffer(), offset * sizeof(value_type),
      count * sizeof(value_type), ::boost::addressof(*first));
...
inline svm_ptr<T> copy_to_device(HostIterator first, HostIterator last,
  ...
  queue.enqueue_svm_memcpy(result.get(), ::boost::addressof(*first),
                           count * sizeof(T));
