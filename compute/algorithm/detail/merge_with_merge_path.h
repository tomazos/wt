...
#include "compute/algorithm/detail/merge_path.h"
...
class serial_merge_kernel : meta_kernel {
 public:
  ...
  serial_merge_kernel() : meta_kernel("merge") { tile_size = 4; }

  template <class InputIterator1, class InputIterator2, class InputIterator3,
            class InputIterator4, class OutputIterator, class Compare>
  void set_range(InputIterator1 first1, InputIterator2 first2,
    ...
    *this << "uint i = get_global_id(0);\n"
          ...
          << "{\n"
          << "   if(!("
          << comp(first2[expr<uint_>("start2")], first1[expr<uint_>("start1")])
          << "))\n"
  ...
  void set_range(InputIterator1 first1, InputIterator2 first2,
    ...
    set_range(first1, first2, tile_first1, tile_last1, tile_first2, result,
              less_than);
  }
...
template <class InputIterator1, class InputIterator2, class OutputIterator,
          class Compare>
inline OutputIterator merge_with_merge_path(
...
inline OutputIterator merge_with_merge_path(
  ...
  ::boost::compute::less<value_type> less_than;
  return merge_with_merge_path(first1, last1, first2, last2, result, less_than,
                               queue);
}
