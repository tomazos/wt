...
#include "compute/algorithm/detail/find_extrema_with_reduce.h"
#include "compute/algorithm/detail/find_extrema_with_atomics.h"
...
inline InputIterator find_extrema(InputIterator first, InputIterator last,
