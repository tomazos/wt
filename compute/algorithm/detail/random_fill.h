...
#include "compute/random/default_random_engine.h"
#include "compute/random/uniform_real_distribution.h"
...
inline void random_fill(OutputIterator first, OutputIterator last, Generator &g,
                        command_queue &queue) {
...
inline void random_fill(
  ...
  typedef typename boost::compute::default_random_engine engine_type;
  typedef typename boost::compute::uniform_real_distribution<value_type>
      distribution_type;
