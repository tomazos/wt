...
#include "compute/algorithm/equal.h"
...
inline bool is_permutation(InputIterator1 first1, InputIterator1 last1,
  ...
  return equal(temp1.begin(), temp1.end(), temp2.begin(), queue);
}
