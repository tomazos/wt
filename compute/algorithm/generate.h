...
#include "compute/iterator/function_input_iterator.h"
...
inline void generate(OutputIterator first, OutputIterator last,
                     Generator generator,
  ...
  ::boost::compute::copy(::boost::compute::make_function_input_iterator(
                             generator, first.get_index()),
                         ::boost::compute::make_function_input_iterator(
                             generator, last.get_index()),
                         first, queue);
}
