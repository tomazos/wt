...
#include "compute/algorithm/detail/search_all.h"
...
inline InputIterator find_end_helper(InputIterator first, InputIterator last,
...
inline TextIterator find_end(TextIterator t_first, TextIterator t_last,
  ...
  detail::search_kernel<PatternIterator, TextIterator, vector<uint_>::iterator>
      kernel;
  ...
  vector<uint_>::iterator index = detail::find_end_helper(
      matching_indices.begin(), matching_indices.end(), _1 == 1, queue);
