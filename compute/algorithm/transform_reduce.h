...
template <class InputIterator, class OutputIterator,
          class UnaryTransformFunction, class BinaryReduceFunction>
inline void transform_reduce(InputIterator first, InputIterator last,
  ...
  ::boost::compute::reduce(
      ...
      result, reduce_function, queue);
}

/// \overload
template <class InputIterator1, class InputIterator2, class OutputIterator,
          class BinaryTransformFunction, class BinaryReduceFunction>
inline void transform_reduce(InputIterator1 first1, InputIterator1 last1,
  ...
  ::boost::compute::transform_reduce(
      ...
      result, detail::unpack(transform_function), reduce_function, queue);
}
