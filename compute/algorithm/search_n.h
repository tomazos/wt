...
class search_n_kernel : public meta_kernel {
 public:
  ...
  void set_range(TextIterator t_first, TextIterator t_last, value_type value,
                 size_t n, OutputIterator result) {
    m_n = n;
...
inline TextIterator search_n(TextIterator t_first, TextIterator t_last,
                             size_t n, ValueType value,
  ...
  detail::search_n_kernel<TextIterator, vector<uint_>::iterator> kernel;
  ...
  if (index == matching_indices.end()) return t_last;
