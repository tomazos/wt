...
#include "compute/algorithm/adjacent_find.h"
...
inline bool is_sorted(InputIterator first, InputIterator last, Compare compare,
...
inline bool is_sorted(InputIterator first, InputIterator last,
                      command_queue &queue = system::default_queue()) {
