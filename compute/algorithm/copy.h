...
#include "compute/algorithm/detail/copy_on_device.h"
#include "compute/algorithm/detail/copy_to_device.h"
#include "compute/algorithm/detail/copy_to_host.h"
#include "compute/async/future.h"
#include "compute/detail/is_contiguous_iterator.h"
...
struct can_copy_with_copy_buffer
    : mpl::and_<
          boost::is_same<InputIterator,
                         buffer_iterator<typename InputIterator::value_type> >,
          boost::is_same<OutputIterator,
                         buffer_iterator<typename OutputIterator::value_type> >,
          boost::is_same<typename InputIterator::value_type,
                         typename OutputIterator::value_type> >::type {};

// host -> device
template <class InputIterator, class OutputIterator>
inline OutputIterator dispatch_copy(
    InputIterator first, InputIterator last, OutputIterator result,
    command_queue &queue,
    typename boost::enable_if_c<
        !is_device_iterator<InputIterator>::value &&
        is_device_iterator<OutputIterator>::value>::type * = 0) {
...
// host -> device (async)
template <class InputIterator, class OutputIterator>
inline future<OutputIterator> dispatch_copy_async(
    InputIterator first, InputIterator last, OutputIterator result,
    command_queue &queue,
    typename boost::enable_if_c<
        !is_device_iterator<InputIterator>::value &&
...
inline OutputIterator dispatch_copy(
    ...
    typename boost::enable_if<mpl::and_<
        is_device_iterator<InputIterator>, is_device_iterator<OutputIterator>,
        mpl::not_<can_copy_with_copy_buffer<InputIterator,
                                            OutputIterator> > > >::type * = 0) {
...
inline OutputIterator dispatch_copy(
    ...
    typename boost::enable_if<mpl::and_<
        is_device_iterator<InputIterator>, is_device_iterator<OutputIterator>,
        can_copy_with_copy_buffer<InputIterator, OutputIterator> > >::type * =
        0) {
  ...
  queue.enqueue_copy_buffer(first.get_buffer(), result.get_buffer(),
