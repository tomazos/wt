...
#include "compute/algorithm/merge.h"
...
inline void inplace_merge(Iterator first, Iterator middle, Iterator last,
  ...
  ::boost::compute::merge(left.begin(), left.end(), right.begin(), right.end(),
                          first, queue);
}
