...
class function_input_iterator_base {
 public:
  typedef ::boost::iterator_facade<
      ...
      typename ::boost::compute::result_of<Function()>::type> type;
};
...
inline meta_kernel &operator<<(
    meta_kernel &kernel, const function_input_iterator_expr<Function> &expr) {
...
class function_input_iterator
 ...
 public:
  typedef
      typename detail::function_input_iterator_base<Function>::type super_type;
  ...
  function_input_iterator(const function_input_iterator<Function> &other)
      : m_function(other.m_function), m_index(other.m_index) {}

  function_input_iterator<Function> &operator=(
      const function_input_iterator<Function> &other) {
    if (this != &other) {
  ...
  template <class Expr>
  detail::function_input_iterator_expr<Function> operator[](
 ...
 private:
  ...
  difference_type distance_to(
      const function_input_iterator<Function> &other) const {
...
template <class Function>
inline function_input_iterator<Function> make_function_input_iterator(
    const Function &function, size_t index = 0) {
...
template <class Function>
struct is_device_iterator<function_input_iterator<Function> >
    : boost::true_type {};
