...
class opengl_renderbuffer : public image_object {
 public:
  ...
  opengl_renderbuffer() : image_object() {}
  ...
  opengl_renderbuffer(const context &context, GLuint renderbuffer,
    ...
    m_mem = clCreateFromGLRenderbuffer(context, flags, renderbuffer, &error);
  ...
  opengl_renderbuffer(const opengl_renderbuffer &other) : image_object(other) {}
...
struct set_kernel_arg<opengl_renderbuffer>
    : public set_kernel_arg<image_object> {};
