...
#include "compute/exception/unsupported_extension_error.h"
...
// name of the OpenGL sharing extension for the system
...
#else
  typedef cl_int (*GetGLContextInfoKHRFunction)(const cl_context_properties *,
                                                cl_gl_context_info, size_t,
                                                void *, size_t *);
  ...
  BOOST_THROW_EXCEPTION(unsupported_extension_error(cl_gl_sharing_extension));
}
