...
struct bound_info_function {
  bound_info_function(Function function, Object object, AuxInfo aux_info)
      : m_function(function), m_object(object), m_aux_info(aux_info) {}

  template <class Info>
  cl_int operator()(Info info, size_t size, void *value,
...
template <class Function, class Object>
inline bound_info_function<Function, Object, void> bind_info_function(
    Function f, Object o) {
  return bound_info_function<Function, Object, void>(f, o);
}

template <class Function, class Object, class AuxInfo>
inline bound_info_function<Function, Object, AuxInfo> bind_info_function(
    Function f, Object o, AuxInfo j) {
...
#define BOOST_COMPUTE_DETAIL_DEFINE_GET_INFO_SPECIALIZATION( \
    object_type, result_type, value)                         \
  namespace detail {                                         \
  template <>                                                \
  struct get_object_info_type<object_type, value> {          \
    typedef result_type type;                                \
  };                                                         \
  }                                                          \
  template <>                                                \
  inline result_type object_type::get_info<value>() const {  \
...
#define BOOST_COMPUTE_DETAIL_DEFINE_GET_INFO_SPECIALIZATIONS(object_type, seq) \
  BOOST_PP_SEQ_FOR_EACH(BOOST_COMPUTE_DETAIL_DEFINE_GET_INFO_IMPL,             \
                        object_type, seq)
