...
#define BOOST_COMPUTE_DETAIL_DECLARE_FUNDAMENTAL(type)                \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(type, _)> : boost::true_type {}; \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(BOOST_PP_CAT(type, 2), _)>       \
      : boost::true_type {};                                          \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(BOOST_PP_CAT(type, 4), _)>       \
      : boost::true_type {};                                          \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(BOOST_PP_CAT(type, 8), _)>       \
      : boost::true_type {};                                          \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(BOOST_PP_CAT(type, 16), _)>      \
      : boost::true_type {};                                          \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(cl_, BOOST_PP_CAT(type, 2))>     \
      : boost::true_type {};                                          \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(cl_, BOOST_PP_CAT(type, 4))>     \
      : boost::true_type {};                                          \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(cl_, BOOST_PP_CAT(type, 8))>     \
      : boost::true_type {};                                          \
  template <>                                                         \
  struct is_fundamental<BOOST_PP_CAT(cl_, BOOST_PP_CAT(type, 16))>    \
      : boost::true_type {};
