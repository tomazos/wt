...
class normal_distribution {
 public:
  ...
  result_type mean() const { return m_mean; }

  /// Returns the standard-deviation of the distribution.
  result_type stddev() const { return m_stddev; }
  ...
  void generate(OutputIterator first, OutputIterator last, Generator &generator,
    ...
    BOOST_COMPUTE_FUNCTION(RealType2, box_muller, (const uint2_ x), {
      ...
      return (RealType2)(MEAN, MEAN) +
             (RealType2)(z1, z2) * (RealType2)(STDDEV, STDDEV);
    });
    ...
    transform(make_buffer_iterator<uint2_>(tmp.get_buffer(), 0),
